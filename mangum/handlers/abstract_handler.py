...
class AbstractHandler(metaclass=ABCMeta):
    ...
    def from_trigger(
        ...
        handler correctly.
        """
        logger.debug(f"Trigger event is: {trigger_event}")
        ...
        if (
            ...
            logger.debug("AwsCfLambdaAtedge")
